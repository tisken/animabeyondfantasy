  ...
  const getDamage = () => {
    ...
    if (useFormula && formula) {
      ...
      if (value !== null && !Number.isNaN(value)) {
        ...
        const extraDamage2 = data.general.modifiers.extraDamage.final?.value ?? 0;
    ...
    const extraDamage = data.general.modifiers.extraDamage.final.value + weapon.system.damage.special.value;
