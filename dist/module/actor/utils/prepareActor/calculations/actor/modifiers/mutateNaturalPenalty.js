...
const mutateNaturalPenaltyUnreduced = (data) => {
...
const mutateNaturalPenaltyReduction = (data) => {
...
const mutateNaturalPenaltyFinal = (data) => {
  let equippedArmorsPenalty = calculateEquippedArmorsNaturalPenalty(data);
  data.general.modifiers.naturalPenalty.final.value = data.general.modifiers.naturalPenalty.unreduced.value + data.general.modifiers.naturalPenalty.reduction.value + equippedArmorsPenalty + data.general.modifiers.naturalPenalty.base.value + data.general.modifiers.naturalPenalty.special.value;
};
