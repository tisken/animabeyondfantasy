...
function stripSystemPrefix(systemPath) {
  return typeof systemPath === "string" && systemPath.startsWith("system.") ? systemPath.slice("system.".length) : systemPath;
}
...
class BaseType {
  ...
  _instanceExtraDeps = /* @__PURE__ */ new Map();
   ...
   */
  ensureDefaultKey() {
    const current = this._get("key", void 0);
