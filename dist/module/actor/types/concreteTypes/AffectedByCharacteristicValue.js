...
class AffectedByCharacteristicValue extends NumericalValue {
  ...
  static normalizeInflateInput(node) {
    ...
    if (out.attribute && typeof out.attribute === "object" && typeof out.attribute.value === "string") {
      out.attribute = out.attribute.value;
    }
    if (out.attribute === void 0) out.attribute = null;
