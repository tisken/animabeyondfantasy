...
class AttackConfigurationDialog extends FormApplication {
  ...
  getData() {
    ...
    if (!weapon) {
      ...
      if (!combat.projectile || combat.projectile.value === void 0) {
        combat.projectile = { value: false, type: "" };
      }
  ...
  async _updateObject(event, formData) {
    ...
    if (formData["attacker.combat.projectile.value"] !== void 0) {
      formData["attacker.combat.projectile.value"] = formData["attacker.combat.projectile.value"] === "on" || formData["attacker.combat.projectile.value"] === true;
    }
