...
class CombatAttackDialog extends FormApplication {
  constructor(attacker, defender, hooks, options = {}) {
    ...
    if (this.modalData.attacker.distance.enable) {
      ...
      const calculateDistance = (canvas.grid.measurePath ? canvas.grid.measurePath([attackerCenter, defenderCenter]).distance : canvas.grid.measureDistance(attackerCenter, defenderCenter, { gridSpaces: true })) / canvas.dimensions.distance;
